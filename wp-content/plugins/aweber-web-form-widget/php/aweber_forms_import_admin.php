            ...
            <?
                ...
                elseif ($oauth_id and !$pluginAdminOptions['access_secret']) {
                    ...
                    if (!$access_secret) {
                        ...
                        $msg .= "Unable to connect to your AWeber Account";
                        $error = True;

                        # show oauth_id if it failed and an api exception was not raised
                        if ($error_code == "") {
                            $msg .= "<br />Authorization code entered was: $oauth_id <br />";
                            $msg .= "Please make sure you entered the complete authorization code and try again.</div>";
                        } else {
                            $msg .= "<dl><dt>Error Message</dt><dd>$error_code</dd></dl>";
                            $msg .= "Please refer to the <a target='_blank' href='" . $kb_link . "'>knowledge base</a> for assistance or email us at <a href='mailto:help@aweber.com'>help@aweber.com</a></div>";
                        }
