...
== Changelog ==
==2.1==
*Updated MailChimp integration (API v3)
*100% compatibilty with WordPress 4.7
*Minor bug fixes

==2.0.6==
*Improved integration with ConvertKit
*Minor Bug Fixes
*Compatibility with WordPress 4.6.1

==2.0.5==
*Minor bug with statistics table fixed

==2.0.4==
*100% Compatibility with WordPress 4.5.3
*Minor bug fixes

==2.0.3==
*ConvertKit integration has been added
